...
def get_webiste_html(url:str)->str:
    try:
...
def extract_core_website_content(html:str)->str:
    input_prompt = f"""
      ...
      Extract the core content and return it as plain text.
    """
...
def summarize_content(content:str)->str:
    input_prompt = f'''
      ...
      Provide a brief summary of the main points in the content. Prefer bullet points and avoid unnecessary explanation.
    '''
...
def generate_x_post(summary:str)->str:
    ...
    prompt = f'''
        ...
        Here's the summary which you need to generate a post:
        <summary>
        {summary}
        </summary>    
...
def main():
    ...
    try:
        html_content = get_webiste_html(website_url)
    except Exception as e:
        print("An error occured while fetching the  website: {e}")
        return
    ...
    print("------")
    print("Generating X post based on summary...")
